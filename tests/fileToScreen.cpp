...
#define BOOST_TEST_MODULE test suite fileToScreen
...
BOOST_AUTO_TEST_CASE(displaying_video){
    ...
    BOOST_REQUIRE_MESSAGE(boost::unit_test::framework::master_test_suite().argc > 1, "agrs: <input>");
    ...
    BOOST_TEST_MESSAGE(" * Displaying \"" << inFile << "\"...");
